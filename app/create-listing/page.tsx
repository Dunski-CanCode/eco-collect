...
export default function CreateListing() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setLoadingStep("Saving your listing...");
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              ...
              className="w-full py-5 rounded-2xl font-black shadow-lg transition-all active:scale-95 disabled:opacity-80 flex items-center justify-center gap-3"
              style={{ backgroundColor: success ? "#4A6741" : "#4A6741", color: "white" }}
            >
              {success ? (
                <span className="flex items-center gap-2">✓ LISTING POSTED — REDIRECTING...</span>
              ) : loading ? (
